...
('doctor01@mail.com', 'doctor01', 'hash_pw29', 'BS. Nguyen Van Bao', 'doctor'),
('doctor02@mail.com', 'doctor02', 'hash_pw30', 'BS. Tran Thi Cam', 'doctor'),
('doctor03@mail.com', 'doctor03', 'hash_pw31', 'BS. Le Van Dung', 'doctor'),
('doctor04@mail.com', 'doctor04', 'hash_pw32', 'BS. Pham Thi Ha', 'doctor'),
('doctor05@mail.com', 'doctor05', 'hash_pw33', 'BS. Hoang Van Hieu', 'doctor'),
('doctor06@mail.com', 'doctor06', 'hash_pw34', 'BS. Do Thi Khanh', 'doctor'),
('doctor07@mail.com', 'doctor07', 'hash_pw35', 'Dr. Michael Scott', 'doctor'),
('doctor08@mail.com', 'doctor08', 'hash_pw36', 'Dr. Emily Clark', 'doctor'),
('doctor09@mail.com', 'doctor09', 'hash_pw37', 'Dr. David Lee', 'doctor'),
('doctor10@mail.com', 'doctor10', 'hash_pw38', 'Dr. Sarah Adams', 'doctor'),
('doctor11@mail.com', 'doctor11', 'hash_pw39', 'Dr. Daniel White', 'doctor'),
('doctor12@mail.com', 'doctor12', 'hash_pw40', 'Dr. Emma Harris', 'doctor'),
('doctor13@mail.com', 'doctor13', 'hash_pw41', 'Dr. Matthew Lewis', 'doctor'),
('doctor14@mail.com', 'doctor14', 'hash_pw42', 'Dr. Olivia Hall', 'doctor'),
('doctor15@mail.com', 'doctor15', 'hash_pw43', 'Dr. Christopher Young', 'doctor'),
('doctor16@mail.com', 'doctor16', 'hash_pw44', 'Dr. Grace King', 'doctor');
-- ==========================
...
INSERT INTO Web_staff (user_id, position, status)
VALUES
(2,'support','online'),
(3,'developer','offline'),
(4,'designer','online');
...
INSERT INTO Office (user_id, name, address, website, logo, description, status)
VALUES
(21,'Hanoi Central Hospital','123 Pho Hue, Hanoi','www.hch.vn','logo1.png','Top hospital in Hanoi','approved'),
(22,'Saigon Clinic','456 Le Loi, HCMC','www.sgclinic.vn','logo2.png','Private clinic in Saigon','approved'),
(23,'EuroCare Medical Center','12 Oxford St, London','www.eurocare.uk','logo3.png','European medical center','approved'),
(24,'New York General Hospital','789 Broadway, NYC','www.nygh.com','logo4.png','US based hospital','approved');
-- ==========================
...
INSERT INTO Doctor (office_id, photo, degree, graduate, specialty_id)
VALUES
...
INSERT INTO Appointment_slot (office_id, doctor_id, start_time, end_time, status)
VALUES
